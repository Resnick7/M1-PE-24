...
CREATE TABLE `concierto` (
  ...
  CONSTRAINT `concierto_ibfk_1` FOREIGN KEY (`id_orquesta`) REFERENCES `orquesta` (`id_orquesta`)
...
INSERT INTO `concierto` VALUES (1,'Mendoza','Argentina',2023,10,2),(2,'Buenos Aires','Argentina',2023,10,4),(3,'Mendoza','Argentina',2023,9,5),(4,'Córdoba','Argentina',2013,7,2),(5,'Mendoza','Argentina',2023,8,1);
